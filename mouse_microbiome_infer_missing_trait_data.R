...
ggplot(x, aes(x = Copies_16S_rrnDB, y = Copies_16S_PICRUSt)) + 
  geom_point(alpha = 0.1) + 
  stat_smooth(method = 'lm') + 
  geom_abline(slope = 1, lty = 3) + 
  labs(x = '16S Gene Copy Number inferred using rrnDB + subtree averaging', 
       y = '16S Gene Copy Number inferred using PICRUSt')
