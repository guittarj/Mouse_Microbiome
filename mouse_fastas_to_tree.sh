...
#combine LTP and mouse data
cat LTP.fasta otus.fa > LTP_mouse.fa

#calculate distance matrix (~30min)
/mnt/research/rdp/public/thirdParty/usearch10.0.240_i86linux64 -calc_distmx LTP_mouse.fa -distmxout LTP_mouse_mx.txt

#turn distance matrix into a tree (~1hr)
/mnt/research/rdp/public/thirdParty/usearch10.0.240_i86linux64 -cluster_aggd LTP_mouse_mx.txt -treeout LTP_mouse.tree -clusterout LTP_mouse_clusters.txt -id 0.80 -linkage min
